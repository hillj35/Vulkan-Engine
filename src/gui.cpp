...
namespace lve {
LveGui::LveGui(LveDevice &device, LveSwapChain &swapChain, LveWindow &window)
...
void LveGui::draw(VkCommandBuffer cmd, VkImageView targetImageView) {
    VkRenderingAttachmentInfo colorAttachment =
        init::attachmentInfo(targetImageView, nullptr, VK_IMAGE_LAYOUT_GENERAL);
    VkRenderingInfo renderInfo =
        init::renderingInfo(swapChain.getSwapChainExtent(), &colorAttachment, nullptr);
