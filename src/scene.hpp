...
class IScene {
public:
    IScene(LveDevice &device, ApplicationPipelines pipelines)
        : lveDevice{device}, pipelines{pipelines} {}
    virtual ~IScene() = default;
    virtual void initScene() = 0;
    virtual void destroyScene() = 0;
    virtual void draw(VkCommandBuffer cmd, LveSwapChain &swapChain, int imageIndex,
